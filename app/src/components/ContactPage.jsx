...
import { WHATSAPP_NUMBER, WHATSAPP_NUMBER_SECONDARY } from "../data/villas";

export default function ContactPage() {
  const primaryRaw = WHATSAPP_NUMBER || "18293410707";
  const primaryDisplay = "829 341 0707";
  const secondaryRaw = WHATSAPP_NUMBER_SECONDARY || "18296511212";
